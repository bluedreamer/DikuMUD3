...
void *bread_dil(CByteBuffer *pBuf, unit_data *owner, uint8_t version, unit_fptr *fptr, int stspec)
{
#ifdef DMSERVER
    dilprg *prg = nullptr;
    diltemplate *tmpl = nullptr;
...
unit_fptr *bread_func(CByteBuffer *pBuf, uint8_t version, unit_data *owner, int stspec)
{
